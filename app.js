...
<style>
  ...
  <div class="page-break"><h2>BAB III<br>PEMBAHASAN PRAKTIK KERJA LAPANGAN</h2>${reportDiscussionHtml(approved, imageSources, { totalHours }).replace(/<img /g, '<img style="width:220pt;height:auto;max-width:220pt;max-height:170pt;display:block;margin:0 auto;" ')}</div>
...
async function downloadGroupPklReportWord(groupKey) {
  ...
  try {
    ...
    discussionHtml = discussionHtml
      .replace(/<img /g, '<img style="width:220pt;height:auto;max-width:220pt;max-height:170pt;display:block;margin:0 auto;" ')
